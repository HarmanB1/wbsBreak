...
export const PrivNav = () => {
  ...
  return (
    <>
      <nav className="relative flex bg-orange-100 dark:bg-orange-100   p-4 gap-x-3 items-center h-16 ">
        ...
        <div className="sm:block ml-auto relative" ref={profileRef}>
          ...
          <div
            className={`absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-orange-100 text-black py-1 z-50 transition-all duration-400 origin-right pl-4  ${
              profMod
