          ...
          {["signup", "login"].map((tab) => (
            <motion.button
              ...
              animate={{
                backgroundColor:
                  tab === activeTab
                    ? " rgba(233, 148, 36, 0.2)" // active
                    : " rgba(255, 237, 213, 1)", // inactive
              }}
            ...
            >
              ...
              {tab === activeTab && (
                <motion.div
                  layoutId="underline" // shared underline animation
                  className="absolute bottom-0 left-0 h-1 bg-orange-500 rounded"
                  style={{ width: "100%" }}
                />
              )}
            </motion.button>
